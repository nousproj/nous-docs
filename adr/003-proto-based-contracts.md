...
- [dependency-graph.md](../architecture/dependency-graph.md) — Proto consumption pattern
- [contract-ownership.md](../../.claude/docs/contract-ownership.md) — Proto ownership matrix (forensics artifact)
